...
You'll need [Thonny](https://thonny.org/) on your laptop, as well as the PixelStrip support files:  `npxl.py`, `pixelstrip.py`, and `colors.py`.
...
Copy the `npxl.py`, `pixelstrip.py`, and `colors.py` files into your project, and then create the following in a file named `main.py`:
